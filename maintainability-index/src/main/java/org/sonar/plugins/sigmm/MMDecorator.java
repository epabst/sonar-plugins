...
public final class MMDecorator implements org.sonar.api.batch.Decorator {
  ...
  public void decorate(Resource resource, DecoratorContext context) {
    ...
    MMRank complexityRanking = computeComplexityRanking(ncloc);
    ...
    MMRank analysibilityRanking = MMRank.averageRank(volumeRanking, duplicationRanking, unitSizeRanking, unitTestingRanking);

    MMRank maintainabilityRanking = MMRank.averageRank(testabilityRanking, stabilityRanking, changeabilityRanking, analysibilityRanking);
    ...
    context.saveMeasure(MMMetrics.ANALYSABILITY, analysibilityRanking.getValue());
