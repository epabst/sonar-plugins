...
@RemoteServiceRelativePath("submitComments")
public interface SubmitCommentsService extends RemoteService {
 
   String getSVNRevision(String url) throws SonarCodeReviewException;
   String submitComments(Comments commentList);
