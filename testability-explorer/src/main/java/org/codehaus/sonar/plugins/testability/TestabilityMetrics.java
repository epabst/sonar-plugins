...
public class TestabilityMetrics implements Metrics {
  ...
  public static final Metric NEEDSWORK_CLASSES = new Metric(
      KEY_NEEDSWORK_CLASSES,
      "Needs work classes",
      "Number of classes qualified as hard to test (needs work)",
      Metric.ValueType.INT,
  ...
  public static final Metric TESTABILITY_COST = new Metric(
      KEY_TESTABILITY_COST,
      "Overall cost",
      "Cost of testability",
      Metric.ValueType.INT,
      Metric.DIRECTION_WORST,
  ...
  public static final Metric METHOD_DETAILS_COST = new Metric(
      KEY_METHOD_DETAILS,
      "Mthod details",
      "Cost of testability detailed by method and line",
