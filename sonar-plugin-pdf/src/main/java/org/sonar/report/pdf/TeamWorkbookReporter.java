...
public class TeamWorkbookReporter extends PDFReporter {

    private URL logo;
    private String projectKey;
    private String sonarUrl;

    public TeamWorkbookReporter(URL logo, String projectKey, String sonarUrl) {
        this.logo = logo;
    ...
    protected void printFrontPage(Document frontPageDocument, PdfWriter frontPageWriter)
        ...
        try {
            ...
            title.writeSelectedRows(0, -1, frontPageDocument.leftMargin(), pageSize.getHeight() - logoImage.getHeight()
                    - 150, frontPageWriter.getDirectContent());
    ...
    private void printDashboard(Project project, Section section) throws DocumentException, IOException {
        ...
        linesOfCode.addCell(new Phrase(project.getMeasureValue("duplicated_lines_ratio") + " duplicated lines",
                dataFont2));
