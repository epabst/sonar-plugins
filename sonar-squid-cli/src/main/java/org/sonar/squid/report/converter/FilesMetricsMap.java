...
public class FilesMetricsMap<String,Integer> extends HashMap<String,Integer>{
	
	/**
	 * Generated serial version UID.
	 */
	private static final long serialVersionUID = 1519498795360600227L;

	public FilesMetricsMap(int size) {
		super(size);
	}
}
