...
public class GendarmeSensorTest {
  ...
  public void testShouldExecuteOnProject() throws Exception {
    ...
    GendarmeSensor sensor = new GendarmeSensor(null, null, null, null, null, new CSharpConfiguration(conf));
    ...
    sensor = new GendarmeSensor(null, null, null, null, null, new CSharpConfiguration(conf));
    assertFalse(sensor.shouldExecuteOnProject(project));
  }
  ...
  public void testAnalyseResults() throws Exception {
    ...
    GendarmeSensor sensor = new GendarmeSensor(null, null, null, null, parser, new CSharpConfiguration(new BaseConfiguration()));
  ...
  public void testGetReportFilesList() throws Exception {
    ...
    Configuration conf = new BaseConfiguration();
    GendarmeSensor sensor = new GendarmeSensor(fileSystem, null, null, null, null, new CSharpConfiguration(conf));
  ...
  public void testGenerateConfigurationFile() throws Exception {
    ...
    GendarmeSensor sensor = new GendarmeSensor(fileSystem, null, null, profileExporter, null, new CSharpConfiguration(
