...
import org.sonar.plugins.toetstool.xml.Guideline;
import org.sonar.plugins.toetstool.xml.Guideline.ValidationType;
...
public final class ToetstoolSensor implements Sensor {
  ...
  public void analyse(Project project, SensorContext sensorContext) {
    ...
    htmlFileScanner.validateFiles(fileSystem.getFiles(), ToetstoolPlugin.getNrOfSamples(project));
