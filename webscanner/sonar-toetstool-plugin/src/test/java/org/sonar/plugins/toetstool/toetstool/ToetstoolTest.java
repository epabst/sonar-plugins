...
public class ToetstoolTest {
  ...
  private static final String testfile = "src/test/resources/org/sonar/plugins/webscanner/toetstool/a.html";
  ...
  public void validateTestFile() throws InterruptedException, IOException {
    ...
    new ToetsToolValidator("http://xyz", new File("target"), new File("target")).validateFile(file);
