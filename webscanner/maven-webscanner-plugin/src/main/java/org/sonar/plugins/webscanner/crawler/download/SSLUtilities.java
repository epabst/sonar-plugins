...
final class SSLUtilities {
  ...
  /**
   * Set the default Hostname Verifier to an instance of a fake class that trust all hostnames. This method uses the old deprecated API from
   * the com.sun.ssl package.
   *
  ...
  /**
   * Set the default X509 Trust Manager to an instance of a fake class that trust all certificates, even the self-signed ones. This method
   * uses the old deprecated API from the com.sun.ssl package.
   *
  ...
  /**
   * Return true if the protocol handler property java. protocol.handler.pkgs is set to the Sun's com.sun.net.ssl. internal.www.protocol
  ...
  /**
   * This class implements a fake hostname verificator, trusting any host name. This class uses the old deprecated API from the com.sun. ssl
   * package.
   *
   * @author Francis Labrie
   *
   ...
   * certificates. This class uses the old deprecated API from the com.sun.ssl package.
   *
   * @author Francis Labrie
   *
