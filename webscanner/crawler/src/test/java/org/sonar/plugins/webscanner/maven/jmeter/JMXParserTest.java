...
import org.sonar.plugins.webscanner.maven.jmeter.JMXParser;

public class JMXParserTest {

  private static final String testfile = "src/test/resources/org/sonar/plugins/webscanner/maven/jmeter/jmeter.jmx";
